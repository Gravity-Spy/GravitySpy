...
import ML.train_classifier as train_classifier
...
#THEANO_FLAGS=mode=FAST_RUN,device=gpu,floatX=float32 python trainmodel.py --path-to-golden /home/scoughlin/public_html/GravitySpy/TrainingSet2/H1L1/ --path-to-pickle ./pickleddata/ --path-to-trained-model ./model --number-of-classes 22 --batch-size 500
